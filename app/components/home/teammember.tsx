...
export function TeamMember({ photo, name, position, exp }: TeamMemberProps) {
  return (
    <div className="border rounded-[45px] px-15 py-20 border-b-[6px]">
      <div className="pb-7 border-b flex justify-between gap-5 w-full">
        <div>
        ...
        <div className="flex flex-col justify-end">
            ...
            <div className="font-normal text-xl shrink-0">
            {position}
            </div>
        </div>
